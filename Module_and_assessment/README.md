...
### Late Stage Gateway
The LSG, at the end of Spring Term, is a brief presentation (max 10 minutes) on the final project goals, together with a schematic plan of works up to the Master's Project deadline. The presentation should contain a brief statement of original goals and the current status plus a Gantt chart, or a list of tasks/milestones with associated timing. Students will need to get in touch with the First Assessor, who will arrange for the presentation to take place. As for the Early Stage Gateway, the Assessor will then report back to the Supervisor in case specific issues/risks are identified.
